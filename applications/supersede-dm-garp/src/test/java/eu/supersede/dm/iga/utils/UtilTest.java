...
public class UtilTest {
	...
	public void testReadDependencies() {
		String deps = "resources/input/dependencies";
	...
	public void testReadPlayerRankings(){
		String ranks = "resources/input/rankings_p1.csv";
		int numRequirements = 6;
	...
	public void testReadCriteria(){
		String criteriaFile = "resources/input/criteria.csv";
	...
	public void testReadRequirements(){
		String requirementsFile = "resources/input/requirements.csv";
		Map<String, String> requirements = Utils.readRequirements(requirementsFile);
		assertTrue(requirements.size() == 6);
		assertTrue(requirements.containsKey("R1"));
		assertTrue(requirements.containsKey("R6"));
	}
