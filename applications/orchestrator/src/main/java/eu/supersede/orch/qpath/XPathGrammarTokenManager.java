/* Generated By:JavaCC: Do not edit this line. XPathGrammarTokenManager.java */
package eu.supersede.orch.qpath;

/** Token Manager. */
public class XPathGrammarTokenManager implements XPathGrammarConstants
{
	...
	public static final String[] jjstrLiteralImages = {
			...
			null, null, null, null, null, null, null, null, "\57", "\72\72", "\52", "\53", 
			"\133", "\40\157\162\40", "\135", "\55", "\100", };
	...
	/** Constructor. */
	public XPathGrammarTokenManager(SimpleCharStream stream){
	...
	/** Constructor. */
	public XPathGrammarTokenManager(SimpleCharStream stream, int lexState){
		this(stream);
		SwitchTo(lexState);
	}
