...
public class GameRest {
			...
			@RequestParam(required = true) String criteriaValues) throws JsonParseException, JsonMappingException, IOException
	{
		...
		for(User u : us)
		{
			...
			notificationUtil.createNotificationForUser(u.getUserId().toString(), "A new decision making process has been created, are you ready to vote?", "game-requirements-gamification/player_games");
