...
public class GANegotiatorVotingMethod implements DMMethod
{
    public static final String NAME = "Negotiate a prioritization task";
    public static final String PAGE = "garp/select_solution";
