...
app.controllerProvider.register('judge_games', function($scope, $http, $location) {
        ...
        $scope.gridSettings =
        {
            ...
            columns: [
                ...
                { text: '', width: '10%', datafield: 'gameId', cellsRenderer: function (row, columnDataField, value) {
                    var r = '<div class="jqx-grid-cell-left-align" style="margin-top: 4px; margin-bottom: 4px;">';
                    r = r.concat("<jqx-link-button jqx-width='75' jqx-height='25'><a href='#/supersede-dm-app/ahprp/judge_acts?gameId=" +
                    value + "'>Enter</a></jqx-link-button>");
                    return r.concat("</div>");
                    }
                }
            ]
